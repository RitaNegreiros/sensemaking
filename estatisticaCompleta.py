...
def csv_to_json(csvFilePath, jsonFilePath):
    ...
    plt.plot(newTimesteps,newPostViews,color='purple',label='Infected (views)')
    plt.plot(newTimesteps,newAllReactions,color='lightBlue',label='Recovered (sum of reactions)')
    plt.plot(newTimesteps,newAsymptContaminated,color='darkOliveGreen',label='Asymptomatic contaminated (viewed but did not share)')
    plt.plot(newTimesteps,newShares,color='limeGreen',label='Symptomatic contaminated (shared)')
    ...
    plt.plot(newTimesteps,newComments,color='maroon',label='Comments')
    plt.plot(newTimesteps,newShares,color='limeGreen',label='Sharing')
    plt.plot(newTimesteps,newPostViews,color='blue',label='Views')
    plt.plot(newTimesteps,newAllReactions,color='magenta',label='Reactions')
